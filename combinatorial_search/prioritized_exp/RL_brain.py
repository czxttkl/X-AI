...
class Memory(object):  # stored as ( s, a, r, s_ ) in SumTree
    ...
    def sample(self, n):
        b_idx, b_memory, ISWeights = np.empty((n,), dtype=np.int32), [None] * n, np.empty((n,), dtype=np.float32)
    ...
    def batch_update(self, tree_idx, abs_errors):
        ...
        # clipped_errors = np.minimum(abs_errors, self.abs_err_default)
        clipped_errors = abs_errors   # do we really need to clip errors?
