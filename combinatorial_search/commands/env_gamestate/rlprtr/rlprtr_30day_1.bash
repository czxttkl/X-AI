...
python -u Q_comb_search.py --env_name="env_gamestate" --k=312 --d=15 --test_period=99999999 --load=0 --env_dir="test_probs/prob_env_gamestate_pv0_envseed303" --learn_wall_time_limit=2591000 --root_dir="prtr_models" > slurm/rlprtr_30day1_out
