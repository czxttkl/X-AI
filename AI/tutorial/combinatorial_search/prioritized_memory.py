...
class Memory(object):
    ...
    def __init__(self, capacity, prioritized, n_features, n_actions, batch_size,
                 qsa_feature_extract, qsa_next_feature_extract):
        ...
        self.qsa_next_feature_extract = qsa_next_feature_extract  # feature vectors for Q(s', a') for all a'
    ...
    def _prioritized_sample(self):
        ...
        for i, (state, action, reward, next_state, terminal) in enumerate(samples):
            ...
            qsa_next_feature[i] = self.qsa_next_feature_extract(next_state)
