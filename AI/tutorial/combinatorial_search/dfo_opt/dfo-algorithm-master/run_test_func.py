...
if __name__ == "__main__":
    ...
    for func in all_func_names:
        ...
        # only COBYLA supports constraints other than bound constraints
        # see:
        # (1) https://docs.scipy.org/doc/scipy/reference/optimize.minimize-cobyla.html#optimize-minimize-cobyla
        # (2) https://nlopt.readthedocs.io/en/latest/NLopt_Algorithms/
        # however, COBYLA cannot deal with mixed integer programming
        alg = 'COBYLA'
