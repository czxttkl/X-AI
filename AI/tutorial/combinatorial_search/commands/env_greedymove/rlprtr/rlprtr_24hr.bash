...
python -u Q_comb_search.py --env_name="env_greedymove" --k=312 --d=15 --test_period=100 --load=0 --env_dir="test_probs/prob_env_greedymove_pv0_envseed303" --learn_wall_time_limit=85400 --root_dir="prtr_models" > slurm/rlprtr_24hr_out
