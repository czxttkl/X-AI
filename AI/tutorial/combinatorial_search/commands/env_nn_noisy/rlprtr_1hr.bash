...
python -u Q_comb_search.py --env_name="env_nn_noisy" --k=312 --d=30 --test_period=100 --load=0 --env_dir="test_probs/prob_env_nn_noisy_pv0_envseed303" --learn_wall_time_limit=3600 --root_dir="prtr_models" > slurm/rlprtr_1hr_out
